...
SurveyReturnValue SurveyAddPerson(Survey Survey, int Id, int Age, bool Gender,
 int EatingHabits , int* Scores);
int* SurveyQuerySurvey(Survey survey, int ChocolateType, bool Gender
, int AgeMin, int AgeMax, int EatingHabits);
